                    ...
                    <form id="myForm" action="responsablesave.php" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nombre_responsable" name="nombre_responsable"
                                required pattern="[A-Za-zÀ-ÿ]+([ ]{0,3}[A-Za-zÀ-ÿ]+)*"
                                title="No se permiten Numeros ni espacios vacios!!!">
                            <div class="invalid-feedback">Por favor ingrese un Nombre</div>
                        </div>
                        <div class="mb-3">
                            <label for="ap_pat_responsable" class="form-label">Apellido Paterno:</label>
                            <input type="text" class="form-control" id="ap_pat_responsable" name="ap_pat_responsable" 
                            required pattern="[A-Za-zÀ-ÿ]+([ ]{0,3}[A-Za-zÀ-ÿ]+)*"
                            title="No se permiten espacios al principio ni numeros">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="ap_mat_responsable" name="ap_mat_responsable" 
                            required pattern="[A-Za-zÀ-ÿ]+([ ]{0,3}[A-Za-zÀ-ÿ]+)*" 
                            title="No se permiten espacios al principio ni numeros">
