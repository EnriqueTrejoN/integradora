...
<body>
    <!-- pode,ms usar el max para el cupo -->
                ...
                <div class="modal-body">
                    <form id="myForm" action="eventosave.php" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <select type="text" class="form-control" id="editId_Categoria" name="Id_Categoria" required>
                        ...
                        <div class="mb-3">
                            ...
                            <select type="text" class="form-control" id="Id_lugar" name="Id_lugar" required>
                ...
                <div class="modal-body">
                    <form id="editForm" action="eventoupdate.php" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="editnom_evento" name="nom_evento" required pattern="[A-Za-zÀ-ÿ]+([ ]{0,3}[A-Za-zÀ-ÿ]+)*"  title="Solo se permiten letras y espacios">
                        </div>
                        <div class="mb-3">
                            <label for="editfecha" class="form-label"> NUEVA FECHA:</label>
                            <input type="date" class="form-control" id="editfecha" name="fecha" required min="<?php echo date('Y-m-d');?>">
                        </div>
                        <div class="mb-3">
    ...
    <script>
        ...
        function fnValidartexto (condicion, mensaje) {
            if (!condicion) {
                Swal.fire({
                    title: 'Error',
                    text: mensaje,
        ...
        function fnGuardar() {
            ...
            // validar que el nombre en formdata contenga letras
            // hacer un trim al nombre del formdata
            var nombre = formData.get('nom_evento').trim();
            if (!fnValidartexto(/^[A-Za-zÀ-ÿ]+([ ]{0,3}[A-Za-zÀ-ÿ]+)*$/.test(nombre), 'El nombre del evento solo puede contener letras y espacios.' ) ){
                return;
            }
            // validar que la fecha sea valida
            var fecha = formData.get('fecha');
            if (!fnValidartexto(/^\d{4}-\d{2}-\d{2}$/.test(fecha), 'La fecha no es válida, debe ser en formato YYYY-MM-DD.' ) ){
                return;
            }

            // validar que la hora sea valida
